...
static const blink_step_t wifi_noconfig[] = {
...
static const blink_step_t wifi_connecting[] = {
    ...
    {LED_BLINK_HOLD, LED_STATE_OFF, 900},
    {LED_BLINK_LOOP, 0, 0},
};

static const blink_step_t wifi_awss_press[] = {
    {LED_BLINK_HOLD, LED_STATE_ON, 250},
    {LED_BLINK_HOLD, LED_STATE_OFF, 250},
    {LED_BLINK_LOOP, 0, 0},
};

static const blink_step_t wifi_awss_communicate[] = {
    {LED_BLINK_HOLD, LED_STATE_ON, 100},
...
static const blink_step_t cloud_connected[] = {
...
blink_step_t const * led_indicator_blink_lists[] = {
    [BLINK_WIFI_NOCONFIG] = wifi_noconfig,
    [BLINK_WIFI_CONNECTING] = wifi_connecting,
    [BLINK_AWSS_PRESS] = wifi_awss_press,
    [BLINK_AWSS_COMM] = wifi_awss_communicate,
    [BLINK_WIFI_CONNECTED] = wifi_connected,
    [BLINK_CLOUD_CONNECTED] = cloud_connected,
...
led_indicator_handle_t led_indicator_create(int io_num, const led_indicator_config_t* config)
{
    ...
    switch (p_led_indicator->mode)
    {
        case LED_GPIO_MODE:        /**< blink with max brightness*/
            ...
            _led_set_state(p_led_indicator->io_num, p_led_indicator->off_level, LED_STATE_OFF);
            }
            break;
